...
2. Update the `LOGO_PATH` variable in `HomePage.java` as needed.
3. Confirm required fonts (e.g., Segoe Script, Trajan Pro, Calibri) are available, or update font settings in the code.
